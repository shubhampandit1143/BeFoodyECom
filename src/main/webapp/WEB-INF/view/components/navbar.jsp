...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Be-Foody</i></h3></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
  India's 1st online store were you get both prepared food and raw materials for food you want to prepare. Their attempt is make you feel relax and make your life easy and saving your time.
<br><br> Transactions have been going on all over the world for centuries, locally, and across locations. Keeping the same concept in mind, now think electronic.
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 XXXXX0000 / +91 XXXX11111<br>
